 ...
 */
   ...
   const short int year = 2020;
   const short int month = 3;
   const short int day = 14;
   const short int leap_secs = 33;
   const short int accuracy = 0;
   short int error = 0;
   short int de_num = 0;
   
   const double hour = 16.722777777777777777777777777778;
   ...
   const double latitude=38.2464000;
   const double longitude=-85.7636;
